...

{
...

	{
		...
		ZipFile.zip(System.getProperty("err.file.folder.location"), reportFileName);
		String[] to = { "manikannanmarimuthu@gmail.com" };
		String[] cc = { "Karthik@mvitech.com" };
		String[] bcc = {};

		// This is for google
		SendMail.sendMail("manikannanmarimuthu@gmail.com", "ManiKannan8912$", "smtp.gmail.com", "465", "true", "true",
				true, "javax.net.ssl.SSLSocketFactory", "false", to, cc, bcc, "Automation test Reports",
				"Please find the reports attached.\n\n Regards\nWebMaster", path, "GS - Switch Reports.zip");
